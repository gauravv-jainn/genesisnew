  ...
  return (
    ...
    >
      <div className="grid gap-6 lg:grid-cols-[1fr_1.1fr]">
        <Reveal>
          <div className="glass glass-lit relative flex h-full min-h-64 flex-col justify-end overflow-hidden rounded-3xl p-8">
        ...
        <RevealGroup className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          {branding.capabilities.map((capability) => (
            <RevealItem key={capability}>
              <div className="glass flex h-full min-h-28 items-end rounded-2xl p-5 transition-colors duration-300 hover:bg-white/10">
                <span className="text-sm font-medium leading-tight text-bone">
                  {capability}
                </span>
              </div>
            </RevealItem>
