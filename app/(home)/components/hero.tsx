    ...
    <section className="grain relative isolate flex min-h-dvh flex-col justify-end overflow-hidden">
      ...
      */}
          ...
          <div>
            <Reveal>
              ...
              */}
              <SectionLabel
                dot
                className="!inline-flex w-fit !text-scene rounded-full border border-white/12 bg-[rgb(18_7_2/0.72)] px-4 py-2 backdrop-blur-md"
              >
                {hero.eyebrow}
              </SectionLabel>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <p className="mt-6 max-w-xl text-pretty text-body text-scene-dim sm:text-lead">
                {hero.body}
              </p>
            </Reveal>
      ...
      >
        <a
          href="#services"
          className="inline-flex items-center gap-2 text-small tracking-[0.2em] text-scene-dim transition-colors hover:text-scene"
        >
